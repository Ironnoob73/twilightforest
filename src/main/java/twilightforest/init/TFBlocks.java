...
public class TFBlocks {
	...
	public static final RegistryObject<Block> CASTLE_BRICK_WALL = register("castle_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(CASTLE_BRICK.get()).forceSolidOn()));
